(function ($) {
  ...
  $.fn.wPaint.extend({
    ...
    setStrokeStyle: function (color) {
      var hexToRgb, rgbColor;

      // function that transforms hex value to RGB
      // and returns an object with r, g, b and rgb (all values separeted by commas)
      ...
      // get the RGBColor from the hex value
      RGBColor = hexToRgb(color);
      // set the strokeStyle with the RGB color as rgba the 0.5 is the opacity
      this.options.strokeStyle =  "rgba(" + RGBColor.rgb + ", 0.1)";
    ...
    setFillStyle : function(color) {
      ...
      // get the RGBColor from the hex value
      RGBColor = hexToRgb(color);
      // set the fillStyle with the RGB color as rgba the 0.5 is the opacity
      this.options.fillStyle = "rgba(" + RGBColor.rgb + ", 0.2)";
    ...
    /****************************************
     * undo / redo this.menus.all.main._setColorPickerValue('fillStyle', color);
     ****************************************/
    undo: function () {
...
//      this.ctxTemp.stroke();
    ...
    _drawPencilDown: function (e) {
      ...
      //stroke style includes transparency
